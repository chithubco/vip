          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                ...
                <form action="{{ route('send_email') }}" name="login-form" class="clearfix" method="post">
                  {{ csrf_field() }}
                  @if (count($errors) > 0)
                      <div class="col-md-12">
                          <ul>
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <input id="form_username_email" name="email" class="form-control" type="text" placeholder="Enter your email">
                    </div>
                  </div>
