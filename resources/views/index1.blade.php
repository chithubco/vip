...
<div id="side-panel" class="dark" data-bg-img="{{asset('images/bg/bg8.jpg')}}">
  <div class="side-panel-wrap">
    ...
    <div class="row-fluid">
      ...
      <hr>
      <p>Login Details.</p>
      <form action="{{ route('post_login') }}" method="post" name="login-form" class="clearfix">
        {{ csrf_field() }}
    ...
    <div class="header-top bg-deep sm-text-center">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right sm-pull-none sm-text-center"></li>
                <li class="sm-display-block mt-sm-10 mb-sm-10">
                  <a class="btn btn-colored btn-flat btn-theme-colored" href="#" data-toggle="modal" data-target="#myModal" style="float: none;margin: 0px;display: block">Register</a>

                </li>
                <li class="sm-display-block mt-sm-10 mb-sm-10">
                  <a id="side-panel-trigger" class="btn btn-colored btn-flat btn-theme-colored side-panel-trigger" style="float: none;margin: 0px;" href="#" >Login</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div class="main-content">
          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x1280"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{asset('images/vip_slide1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:800;">VIP (Vicampro <br>Investment Plan)
                </div>
                ...
                <div class="tp-caption tp-resizeme text-black-55"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">Transformation of Agricultural Sector in Nigeria Through Inclusive <br>Participation - Crowd Funding
                  By Vicampro Farms LTD
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-flat btn-sm btn-theme-colored" href="#">Donate Now</a>
                </div>
              </li>
              ...
              <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x1280"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="{{asset('images/vipslide2.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway pl-40 pr-40"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:800; border-radius:45px;">Crowd Funding
                </div>
                ...
                <div class="tp-caption tp-resizeme text-center text-black-555"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">Simply the practice of funding a project<br> or venture by raising funds <br>from a large number of people.
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-sm btn-flat btn-theme-colored" href="#">Donate Now</a>
                </div>
              </li>
            </ul>
          </div><!-- end .rev_slider -->
    ...
    <section id="about" class="bg-lighter">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h4 class="m-0">Vicampro</h4>
            <h2 class="title text-theme-colored mt-0">Crowdfunding Approach</h2>
            <ul class="list theme-colored angle-double-right mb-sm-30">
              <li><span class="text-black text-capitalize">Equity Crowd Funding-:</span>Enables participants to invest in a company and becomes shareholder.</li>
              <li><span class="text-black text-capitalize">Debt-based Crowdfunding-:</span>This is also referred to as crowd lending. It allows participants to fund a project or venture with a guaranteed payment of the amount invested and interest agreed upon.</li>
              <li><span class="text-black text-capitalize">Debt Crowdfunding-Interest based-:</span>This allows for a fixed interest payment. The principal and interest is paid at maturity (12 months) to the participant.</li>
              <li><span class="text-black text-capitalize">Debt Crowdfunding-Profit based-:</span>This is designed for investors that do not support interest-based transactions. The principal and proportion of pre-determined earned profit is paid to the investor at maturity (12 Months).</li>
            </ul>

            <h4 class="mt-20 mb-5">VIP Objectives</h4>
            <ul class="list theme-colored angle-double-right mb-sm-30">
          ...
          <div class="col-md-5">
            <div class="fluid-video-wrapper">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Nmce9eCo3CE" frameborder="0" allowfullscreen></iframe>
            </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">Our Investments</h3>
          ...
          <div class="col-md-7">
            <div class="bg-theme-colored-transparent-deep p-40">
              ...
              <form id="paypal_donate_form-onetime" class="hidden" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                ...
                <input type="hidden" name="item_name" value="Sponsorship For Investments"> <!-- updated dynamically -->
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <div id="accordion1" class="panel-group accordion transparent">
              <div class="panel">
                <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion11" class="collapsed" aria-expanded="false"> <span class="open-sub"></span> <strong>Q. What do you mean by item and end product?</strong></a> </div>
          ...
          <div class="row pt-30">
            <div class="col-md-5">
              ...
              <div
                ...
                data-height="500"
                data-latlng="9.71666667,8.91666667"
    ...
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
          <div class="text-center mb-15 col-md-4 col-md-offset-4"><a href="#" class=""><img alt="" src="{{asset('images/logon.png')}}"></a></div>
          <form action="{{route('register_user')}}" class="register-form col-md-12" method="post">
            {{ csrf_field() }}
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input id="form_choose_username" name="email" class="form-control" type="email"/>
              </div>
              <div class="form-group col-md-6">
                <label for="form_choose_username">Confirm Email</label> <star> * </star>
                <input id="form_choose_username" name="email" class="form-control" type="email"/>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input id="form_choose_username" name="phone_number" class="form-control" type="text"/>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
